 ...
 * @author Meli
 */
@WebServlet(description="Simple servlet", urlPatterns={"/detalleHabit"})
public class DetalleHabit extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String codParametro=req.getParameter("codigoHabit");   
